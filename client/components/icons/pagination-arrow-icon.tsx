...
export function PaginationArrowIcon({ className, direction }: Props) {
  ...
  return (
    ...
    >
      {direction === "backward" ? (
        <g transform="matrix(-1,0,0,1,32,0)">{path}</g>
      ) : (
        path
      )}
    </svg>
